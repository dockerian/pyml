...
from ml.utils.extension import get_func
...
class ExtensionTests(unittest.TestCase):
    ...
    def test_json_encoder(self):
        ...
        class JsonEncoderTest(object):
            def __init__(self):
                ...
                self.ns = set([3, 1, 4])
                self.ss = set(["x", "y", "z"])
                self.ts = datetime(2019, 7, 21, 5, 13, 46, 28790, tzinfo=UTC)
                print("\n")
                pass

        s1 = '"age": 33, "name": "Test Name", "ns": [3, 1, 4], "ss": ["y", "x", "z"]'
        s2 = '"ts": "2019-07-21 05:13:46.028790+00:00"'
    ...
    def test_func(self):
        """
        test ml.utils.extension.get_func
        """
        class_args = {"a": 1, "b": 2}
